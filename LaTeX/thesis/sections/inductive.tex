dedicated \section{Inductive Types}
...
constructions are \textit{synthetically} given rules in the deductive system, known as \textit{type formers}.
...
Given $A, B : \U$, we can form the product type $A \times B : \U$ consists of pairs $(a, b)$, given by $a : A, b : B$. 
