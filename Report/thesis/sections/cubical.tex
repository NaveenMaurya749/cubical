...
which are the Kan filling operations $X \fillup$ and $X \filldown$. This is needed in order to justify the elimination rules for identity types.
For a complete treatment, see Simon Huber's PhD Thesis for more details.~\cite{huberphd}
